...
客户端将SDK返回的token和用户输入的待校验手机号码上传到应用服务器，应用服务器调用`本机号码校验`接口，获取用户手机号码。
...
| 参数        | 类型         | 说明                                                   |
| ----------- | ------------ | ------------------------------------------------------ |
| networkType | NSDictionary | 0.无网络;</br>1.数据流量;</br>2.wifi;</br>3.数据+wifi  |
| carrier     | NSDictionary | 0.未知;</br>1.中国移动;</br>2.中国联通;</br>3.中国电信 |
