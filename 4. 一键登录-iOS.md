...
| UAPageContentLoginButtonTitle        | NSString     | 用户自定义登录按钮文字（仅限授权页）                       | 是     | 2                        |      |
...
| UAPageContentLoginButtonTitleFont    | UIFont       | 用户自定义登录按钮字体风格和大小                         | 是     | 2                          |      |
| UAPageContentLoginButtonTitleColor   | UIColor      | 用户自定义登录按钮字体颜色                            | 是     | 2                          |      |
| UAPageContentLoginButtonTitle | NSString | 用户自定义登录按钮文字 | 是 | 2 |
| UAPageContentSeperatorHidden         | NSNumber     | 设置logo下面分割线是否隐藏，YES隐藏，NO显示               | 是     | 2                          |      |
>>>>>>> 00b48fb4b1df085c0603ef64d80f6385601ca63b
